...
func MakeString() {
	...
	//Сколько байт хранит в себе строка
	//На 64-битной системе: 16 байт (8 байт указатель + 8 байт длина)
	//На 32-битной системе: 8 байт (4 байта указатель + 4 байта длина)
	//+
	//Данные строки также нужно считать, допустим
	//s1 := "hello world"
	//Символы "hello world" хранятся отдельно в памяти как массив байтов.
	//"hello world" — это 11 байт (h, e, l, l, o, , w, o, r, l, d)
	//Если строка содержит юникод-символы, каждый символ может занимать 1–4 байта.
	//Итого s1 := "hello world" по факту занимает 27 байт
